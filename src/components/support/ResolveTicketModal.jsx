          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col-reverse sm:flex-row sm:items-center sm:justify-end gap-2 sm:gap-3 p-4 sm:p-6 border-t border-chilled-gray-200 bg-chilled-gray-50">
              ...
              <button
                ...
                className="w-full sm:w-auto px-4 py-2 text-sm font-medium  bg-green-600 rounded-lg hover:bg-green-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
              >
                {isSubmitting ? (
                  <>
