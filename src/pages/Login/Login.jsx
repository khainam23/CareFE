...
const Login = () => {
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4 font-sans">
      <div className="w-full max-w-5xl flex h-[600px] bg-white shadow-2xl rounded-2xl overflow-hidden">
        {/* Left side - Form */}
        <div className="w-1/2 flex flex-col justify-center items-center p-12">
          <div className="w-full max-w-sm">
          <button className="w-full flex items-center justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm bg-blue-600 text-sm font-medium text-white hover:bg-blue-700 transition-colors">
            <img src={GoogleIcon} alt="Google" className="w-5 h-5 mr-3 bg-white rounded-full p-0.5" />
            Đăng nhập bằng google
          </button>            <div className="my-8 flex items-center">
